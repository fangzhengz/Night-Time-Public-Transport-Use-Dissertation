...
files (`bus_rail_relation_analysis`, `rq2_independent_variables`,
`rq3_mismatch_analysis`). GMM component ids are arbitrary, so the 2026-08-01
...
RAW_LONG = (FYP / "data_processing" / "rail_allmodes" / "outputs" / "preprocessed"
            / "numbat_allmodes_station_qhr_all_daytypes_final.parquet")
COORDS = (FYP / "data_processing" / "rail_allmodes" / "outputs" / "data"
