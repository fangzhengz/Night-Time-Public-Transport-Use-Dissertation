...
- Generated: 2026-07-22T14:23:32.916820+00:00
...
matrix for the 432 all-modes stations (LU + DLR + Overground + Elizabeth
...
- BIC difference (K7 minus K6): `-484.630`. K=7 has lower (better) refitted BIC than K=6.
- Silhouette difference (K7 minus K6): `-0.008244`.
- Paired 200-replicate bootstrap ARI: K=6 = `0.518`,
  K=7 = `0.475`.
- Paired difference K6 minus K7: mean `0.042`,
  95% empirical interval `[-0.259, 0.371]`;
  K=6 is higher in `59.5%` of paired resamples.
- Full-data random-seed mean ARI: K=6 = `0.560`,
  K=7 = `0.552`.

## K=6 to K=7 structure

- Adjusted Rand Index: `0.562`
- Best one-to-one matched stations: `305` /
  `432` (`70.6%`)
...
- 201 of the 432 stations here were only added in this extension check and
  have not had the same manual review as the canonical 270.
