...
Station names in operational data do not always correspond one-to-one with physical places. This archive preserves the Rail outputs from before the final co-location correction, when Paddington National Rail and TfL records still appeared as separate analytical units. Its value is comparative: it shows what changed when the physical-station definition was enforced and why downstream results had to be regenerated.
