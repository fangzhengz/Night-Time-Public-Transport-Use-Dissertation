...
This archive captures a short-lived but consequential version of the Rail analysis. It preserved the native operating windows inherited from the Underground-only design, until the wider all-modes population showed that activity after 01:00 was being discarded on ordinary nights. Moving to a common 18:00–05:00 window was therefore a data-coverage correction, not a cosmetic expansion of the feature matrix.

The snapshot contains the all-modes rail result as adopted between 2026-07-30 and 2026-08-01, using
