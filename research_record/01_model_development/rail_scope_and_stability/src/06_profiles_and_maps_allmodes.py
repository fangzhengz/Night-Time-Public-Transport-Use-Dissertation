...
`FYP/cluster_clean_version_fullweek/src/05_figures.py`
...
# Same source the RQ2 results panel (rq2_independent_variables/src/
...
def build_hourly_shares(lab_df: pd.DataFrame) -> pd.DataFrame:
    ...
    Mirrors rq2_independent_variables/src/06_build_cluster_panels.py::
...
def rail_map(lab_df, coords, K, base):
    ...
    # sensitivity check against it, that distinction no longer describes
