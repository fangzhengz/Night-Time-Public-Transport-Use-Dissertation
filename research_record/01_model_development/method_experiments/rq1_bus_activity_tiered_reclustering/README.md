...
This experiment began with a substantive concern about the meaning of the Bus clusters. If low-count temporal shares are much noisier than high-count shares, a shape-based model may separate measurement instability rather than night-time rhythm. The reliable-core idea was an attempt to learn the typology from better-supported observations while still describing, rather than discarding, the lower-activity parts of London.

The analysis formalises the response to a problem identified in the 2026-07-19 pipeline audit
