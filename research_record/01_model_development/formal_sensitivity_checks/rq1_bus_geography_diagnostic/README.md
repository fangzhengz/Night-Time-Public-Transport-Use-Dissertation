...
An early Bus map produced a result that looked geographically counter-intuitive: parts of central London and the outer suburbs appeared in the same cluster. Rather than explaining that pattern after the fact, this diagnostic treats the surprise as a methodological question. It asks whether the map reflects a genuine similarity in night-time rhythm or whether it can be traced to K choice, assignment uncertainty or the aggregation of stops into LSOAs.

The analysis answers a question raised by Howard Wong at the 17 July 2026
