...
(bus_rail_relation_analysis, rq2_independent_variables, rq3_mismatch_analysis).
...
numbat_all_area_test/src/09_cluster_names.py was written to close for rail.
This script closes it for bus.

This script is now the single source. Downstream reads
`outputs/data/bus_cluster_names.csv`; nothing should hardcode a bus cluster
name again -- see bus_rail_relation_analysis/src/config.py and
rq2_independent_variables/src/config.py for the loader pattern already used
for rail's RAIL_CLUSTER_NAMES.
...
# 2026-08-08: repointed from outputs/ (18:00-06:00, min36; archived at
# outputs_archive_1806_min36_2026-08-08/, untouched) to outputs_1805_min33/
# (18:00-05:00, min33).
...
NAMES = {
    ...
    "moderate_directional": ("moderate activity with destination characteristics", "moderate, destination-leaning"),
