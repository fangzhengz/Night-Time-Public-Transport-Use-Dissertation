...
The contextual portrait in the dissertation was assembled variable by variable rather than taken from a single ready-made table. This directory records that construction at its source: which official Census tables were selected, what population each denominator describes, and how London coverage was checked before the indicators were allowed into the analysis.
