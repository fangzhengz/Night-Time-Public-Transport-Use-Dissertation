"""Geometry helper shared by the rail catchment construction.

``finite_voronoi_polygons`` is copied verbatim from
``rq2test analysis/src/run_analysis.py`` (same algorithm, no logic changes)
so this folder does not need to import across sibling analysis folders.
"""
