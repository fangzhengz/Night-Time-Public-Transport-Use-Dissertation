...
- `exploratory/` is a reader-facing index to completed side analyses, context alternatives and the incomplete mobility–public-transport mismatch analysis that were not used as dissertation results.
