...
Extracted 2026-07-24 from `analysis/02_mode_specific_clustering/rail/src/05_build_allmodes_coords_and_map.py`
(that script's coordinate-matching half only -- the comparison-map plotting
half stays in `analysis/02_mode_specific_clustering/rail`, since it needs cluster labels, which
